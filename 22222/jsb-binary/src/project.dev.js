require = function() {
  ...
  AppLog: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "ae6eaNtZvJHVoaAj0Iqd3/Q", "AppLog");
    "use strict";
    ...
    AppLog.trace = function() {
      ...
      AppLog.isLog && backLog.call(AppLog, "%s%s" + cc.js.formatStr.apply(cc, arguments), AppLog.getDateString(), AppLog.stack(2));
    };
    AppLog.log = function() {
      var backLog = cc.log || console.log || log;
      AppLog.isLog && backLog.call(AppLog, "%s%s" + cc.js.formatStr.apply(cc, arguments), AppLog.getDateString(), AppLog.stack(2));
    ...
    AppLog.info1 = function() {
      var backLog = cc.log || console.log || log;
      AppLog.isLog && backLog.call(AppLog, "%c%s%s:" + cc.js.formatStr.apply(cc, arguments), "color:#00CD00;", AppLog.getDateString(), AppLog.stack(2));
    };
    AppLog.log2 = function() {
      var backLog = cc.log || console.log || log;
      AppLog.isLog && backLog.call(AppLog, "%c%s%s:" + cc.js.formatStr.apply(cc, arguments), "color:#EED2EE;", AppLog.getDateString(), AppLog.stack(2));
    };
    AppLog.info2 = function() {
      var backLog = cc.log || console.log || log;
      AppLog.isLog && backLog.call(AppLog, "%c%s%s:" + cc.js.formatStr.apply(cc, arguments), "color:#F08080;", AppLog.getDateString(), AppLog.stack(2));
    };
    AppLog.info3 = function() {
      var backLog = cc.log || console.log || log;
      AppLog.isLog && backLog.call(AppLog, "%c%s%s:" + cc.js.formatStr.apply(cc, arguments), "color:#9B30FF;", AppLog.getDateString(), AppLog.stack(2));
    };
    AppLog.objInfo1 = function(data) {};
    AppLog.objInfo2 = function(data) {};
    AppLog.warn = function() {
      var backLog = cc.log || console.log || log;
      AppLog.isLog && backLog.call(AppLog, "%c%s%s:" + cc.js.formatStr.apply(cc, arguments), "color:#ee7700;", AppLog.getDateString(), AppLog.stack(2));
    };
    AppLog.error = function() {
      var backLog = cc.log || console.log || log;
      AppLog.isLog && backLog.call(AppLog, "%c%s%s:" + cc.js.formatStr.apply(cc, arguments), "color:red", AppLog.getDateString(), AppLog.stack());
    };
  ...
  App: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "8ec2dsaiGFIP73CyjJVGdTq", "App");
    "use strict";
    window.bb = {};
    initLib();
    initScript("GameMsg");
  ...
  BatMenu: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "a22acbd67ZMP6D/Rru/i2sR", "BatMenu");
    "use strict";
    cc.Class({
  ...
  CreateRoom: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "8d112CyBbZFLoUp/3h2iaMO", "CreateRoom");
    "use strict";
    ...
    cc.Class({
      ...
      createRoom: function createRoom() {
        var moshenren = this["_toggle1"].getComponent(cc.Toggle).isChecked;
        moshenren = moshenren ? 0 : 1;
        var type = this["_toggle2"].getComponent(cc.Toggle).isChecked;
        type = type ? 0 : 2;
        var dizhu = this["_edit1"].getComponent(cc.Label).string;
        dizhu = parseInt(dizhu);
        var ruchang = this["_edit2"].getComponent(cc.Label).string;
        ruchang = parseInt(ruchang);
        var lichang = this["_edit3"].getComponent(cc.Label).string;
        lichang = parseInt(lichang);
        ZJHNetManager.getInstance().createRoom(moshenren, 0, type, dizhu, ruchang, lichang);
      },
      _onBtnTouchEnd: function _onBtnTouchEnd(sender) {
        switch (sender.$) {
         case "1":
          this.createRoom();
          break;
      ...
      onEventMessage: function onEventMessage(msgId, obj) {
        var _this = this;
        switch (msgId) {
         ...
         case bb["user"].Name.CreateRoomFaile:
          bb["gameEvent"].notifyEvent(bb["eventName"].ShowOneTip, {
            msg: obj,
            callback: function callback() {
              bb["loader"].destroy(_this.node);
            }
          });
        }
      }
    ...
    ZJHNetManager: "ZJHNetManager"
  } ],
  DropDownMenu: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "797139N5hFCTr62kdhpOkfz", "DropDownMenu");
    "use strict";
    cc.Class({
      extends: cc.Component,
      properties: {},
      ...
      onButtonTouchEnd: function onButtonTouchEnd(sender, custom) {
        this.node.children[1].active = true;
      },
      onScroeViewItemClick: function onScroeViewItemClick(sender, custom) {
  ...
  EnterRoom: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "619e4MxX5hNrKgqOA/ls1VE", "EnterRoom");
    "use strict";
    var ZJHNetManager = require("ZJHNetManager");
    cc.Class({
      extends: cc.Component,
      ...
      updateRoomLable: function updateRoomLable() {
        for (var i = 1; i <= 6; i++) this["_lab" + i].getComponent(cc.Label).string = "";
        for (var _i = 0; _i < this.RoomList.length; _i++) this["_lab" + (_i + 1)].getComponent(cc.Label).string = this.RoomList[_i];
        if (6 == this.RoomList.length) {
          var room = "";
          for (var _i2 = 0; _i2 < this.RoomList.length; _i2++) room += this.RoomList[_i2];
  ...
  EventManager: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "a8f3cFfqL5NIoFezWMBvpMi", "EventManager");
    "use strict";
    var EventManager = cc.Class({
      ...
      addObserver: function addObserver(target) {
        ...
        target ? this.observer_list.push(target) : bb.log("ERR: invalid addObserver target:%s", target);
        this.observer_list.forEach(function(item, index) {
      ...
      removeObserver: function removeObserver(target) {
        var self = this;
        this.observer_list.forEach(function(item, index) {
          item === target && self.observer_list.splice(index, 1);
        });
        this.observer_list.forEach(function(item, index) {
          bb.warn("移除后 第 %s 个观察者 %s", index, item.name);
        });
      },
      removeAllObserver: function removeAllObserver() {
        this.observer_list = [];
      },
      destroyInstance: function destroyInstance() {
        this.eventManager = null;
      },
      notifyEvent: function notifyEvent(event, data) {
      ...
      addProtocolCache: function addProtocolCache(name, data) {
        if (data && name) {
          this.protocol_list.push({
            name: name,
            data: data
          });
        ...
        } else bb.err("协议缓存 数据为空");
        if (this.is_cache || 1 != this.protocol_list.length) bb.warn("已缓存协议ID:%d  (当前缓存队列长度:%s)  is_cache=%s", name, this.protocol_list.length, this.is_cache); else {
          bb.log("无需缓存协议, 直接调用notifyProtocol()...");
          this.notifyProtocol();
          bb.log("notifyProtocol end.");
        }
      },
      notifyProtocol: function notifyProtocol(TAG) {
        ...
        } else bb.log("[%s] notifyProtocol >>> 协议缓存队列为空, 忽略.", TAG);
      },
      notifyProtocolCache: function notifyProtocolCache(TAG) {
        this.is_cache = false;
        this.notifyProtocol(TAG);
      },
      clearProtocolCache: function clearProtocolCache() {
        this.is_cache = false;
        this.protocol_list = [];
      }
    });
  ...
  GameConter: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "5c81bbDI6JBG77ylcP/70sH", "GameConter");
    "use strict";
    ...
    cc.Class({
      ...
      start: function start() {
        ...
        bb["loader"].loadRes("Prefab/LoginScene", cc.Prefab, function(prefab) {
          bb["loader"].instantiate(prefab, _this.node, function(node) {});
        });
        cc.loader.load(cc.url.raw("resources/Config/GameConfig.json"), function(err, json) {
          if (err) {
            cc.log(err);
            return;
          }
          ...
          Http.get(bb["config"].IP, "", "", function(err, data) {
            if (err) return;
      ...
      changeWindow: function changeWindow(obj) {
        var _this2 = this;
        var a = {
          scene: "",
          res: {
        ...
        if (this.isSwitchScene) return;
        if (obj.res) {
          cc.log("切换场景: " + obj.scene);
          var nameList = obj.scene.split("/");
          if (cc.director.getScene().children[0].children[1] == nameList[nameList.length - 1]) return;
        } else {
          cc.log("切换场景: " + obj);
          var _nameList = obj.split("/");
          if (cc.director.getScene().children[0].children[1] == _nameList[_nameList.length - 1]) return;
        }
        ...
        obj.res ? bb["loader"].loadResArr(obj.res, function() {
          bb["loader"].loadRes(obj, cc.Prefab, function(prefab) {
            bb["loader"].instantiate(prefab, _this2.node, function(node) {
              _this2.isSwitchScene = false;
            });
          });
        }) : bb["loader"].loadRes(obj, cc.Prefab, function(prefab) {
          bb["loader"].instantiate(prefab, _this2.node, function(node) {
      ...
      showWindow: function showWindow(obj) {
        var _this3 = this;
        if (this.isSwitchScene) return;
        this.isSwitchScene = true;
        bb["loader"].loadRes(obj, cc.Prefab, function(prefab) {
          bb["loader"].instantiate(prefab, cc.director.getScene().children[0].children[1], function(node) {
            _this3.isSwitchScene = false;
          });
        });
      },
      showOneTip: function showOneTip(obj) {
        bb["loader"].loadRes("Hall/Tip", cc.Prefab, function(prefab) {
          var childrens = cc.director.getScene().children[0].children[1].children;
          bb["loader"].instantiate(prefab, childrens[childrens.length - 1], function(node) {
  ...
  GameMsg: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "1f703aiy0JIp5Qk7+XXcsdv", "GameMsg");
    "use strict";
  ...
  GameNetManager: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "44bc3CPmGBJgp84g3fOwMii", "GameNetManager");
    "use strict";
    var EventManager = require("EventManager");
    ...
    var GameNetManager = cc.Class({
      ...
      ctor: function ctor() {
        ...
        this.nextHeartbeatTimeout = 5;
        this.connectionId = 0;
        this.heartbeatEnable = true;
      },
      init: function init(svrhost) {
        this.connect(svrhost);
      },
      connect: function connect(svrhost, owner) {
        if (!svrhost) {
        ...
        this.gameSocket.onopen = function(event) {
          ...
          network.isFirstConnect = false;
          network.isConnecting = false;
          var isReconnect = network.isReconnect;
          network.resetCount();
          network.initHeartBeat();
          true === isReconnect && network.msgQueue.length > 0;
        };
        this.gameSocket.onmessage = function(event) {
          network.nextHeartbeatTimeout = Date.now() + 1e3 * bb["config"].HEARTBEAT_INTERVAL;
        ...
        this.gameSocket.reconnect = function(forceConnect) {
          ...
          forceConnect && network.resetCount();
          if (network.reconnectAttempts < bb["config"].MAX_RECONNECT_ATTEMPTS) {
            ...
            delayTime > 30 && (delayTime = 30);
            cc.log(now() + "socket.reconnect(" + network.reconnectAttempts + ")... delay:" + delayTime + "秒后connect...");
            network.checkConnTimerId && clearTimeout(network.checkConnTimerId);
            network.reconncetTimer = setTimeout(function() {
              network.connect(network.host);
            }, 1e3 * delayTime);
            network.reconnectAttempts >= 3 && (network.reconnectDelay += 5);
          } else cc.log("超出自动重连次数(%s), 提示用户手动点击重连", network.reconnectAttempts);
        };
      ...
      disconnect: function disconnect() {
        ...
        if (this.gameSocket) {
          ...
          this.gameSocket.disconnect && this.gameSocket.disconnect();
          this.gameSocket.close && this.gameSocket.close();
        }
      },
      reconnect: function reconnect(forceConnect) {
        this.gameSocket.reconnect(forceConnect);
      },
      onReceiveData: function onReceiveData(event) {
        bb.log("收到协议2");
        if (!event["serverId"] && !event["msgId"]) {
          bb.info2("收到心跳包回复");
          return;
        }
        var msgId = 1e3 * event["serverId"] + event["msgId"];
        bb.logObj1("收到服务器发来的数据:");
        bb.logObj1(event);
        this.onMsg(msgId, event);
      },
      sendProto: function sendProto(obj) {
      ...
      resetCount: function resetCount() {
        ...
        this.reconnectDelay = bb["config"].RECONNECT_DELAY;
      ...
      getSocketState: function getSocketState() {
        var state = WebSocket.CLOSED;
        try {
          this.gameSocket && (state = this.gameSocket.readyState);
        } catch (e) {
          bb.err("[%s] getSocketState exception:%s", this.host, e);
        }
        return state;
      },
      initHeartBeat: function initHeartBeat() {
        if (!bb["config"].IsHeartbeat) return;
        ...
        var sendHeartbeat = function sendHeartbeat() {
          ...
          if (network.heartbeatTimeoutId) bb.log("[hbTimeId=%s] 此次不发心跳包, 等待下一个定时周期...", network.heartbeatTimeoutId); else {
            if (!(gap <= 100)) {
            ...
            network.nextHeartbeatTimeout = Date.now() + 1e3 * bb["config"].HEARTBEAT_INTERVAL;
            network.heartbeatTimeoutId = setTimeout(heartbeatTimeoutCb, 1e3 * bb["config"].HEARTBEAT_TIMEOUT);
            bb.log(" 发送心跳包到>>[%s]... (hbId:%s|%s)", network.host, network.heartbeatId, network.heartbeatTimeoutId);
          }
          network.heartbeatId = setTimeout(sendHeartbeat, 1e3 * bb["config"].HEARTBEAT_INTERVAL);
        };
        var heartbeatTimeoutCb = function heartbeatTimeoutCb() {
          ...
          network.heartbeatTimeoutId = null;
          if (gap > 100) network.heartbeatTimeoutId = setTimeout(heartbeatTimeoutCb, gap); else {
  ...
  HallRoomList: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "d4e4a52SsFLrpPIkWNyE2f0", "HallRoomList");
    "use strict";
    var ZJHNetManager = require("ZJHNetManager");
    cc.Class({
      extends: cc.Component,
      ...
      start: function start() {
        bb["ui"].bindComponent(this);
        for (var i = 1; i <= 9; i++) this["_item" + i].active = false;
      ...
      _onBtnCloseTouchEnd: function _onBtnCloseTouchEnd(sender) {
        bb["loader"].destroy(this.node);
      },
      _onBtnCreateRoomTouchEnd: function _onBtnCreateRoomTouchEnd(sender) {
        bb["gameEvent"].notifyEvent(bb["eventName"].ShowWindow, "Hall/CreateRoom");
      },
      _onBtnEnterRoomTouchEnd: function _onBtnEnterRoomTouchEnd(sender) {
        bb["gameEvent"].notifyEvent(bb["eventName"].ShowWindow, "Hall/EnterRoom");
      },
      _onBtnReshTouchEnd: function _onBtnReshTouchEnd(sender) {
        var roomlist = bb["user"].Module.roomList;
      ...
      _onItemTouchEnd: function _onItemTouchEnd(sender) {
  ...
  HallScene: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "2496auEftVF2LLsnuvu3UO8", "HallScene");
    "use strict";
    var ZJHNetManager = require("ZJHNetManager");
    cc.Class({
      extends: cc.Component,
      ...
      _onBtnJinHuaTouchEnd: function _onBtnJinHuaTouchEnd(sender) {
        ZJHNetManager.getInstance().getZJHRoomList();
      },
      _onBtnJoinRoomTouchEnd: function _onBtnJoinRoomTouchEnd(sender) {
        bb["gameEvent"].notifyEvent(bb["eventName"].ShowWindow, "Hall/EnterRoom");
      },
      _onBtnSettingTouchEnd: function _onBtnSettingTouchEnd(sender) {
        bb["gameEvent"].notifyEvent(bb["eventName"].ShowWindow, "Hall/HallSetting");
      },
      _onBtnOptionTouchEnd: function _onBtnOptionTouchEnd(sender) {
        bb["gameEvent"].notifyEvent(bb["eventName"].ShowWindow, "Hall/HallOption");
      },
      _onBtnGoShopTouchEnd: function _onBtnGoShopTouchEnd(sender) {
  ...
  Http: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "758aa6xcVdIZJfJf2HwUH0b", "Http");
    "use strict";
    var Http = {
      get: function get(url, path, params, callback) {
        ...
        xhr.onreadystatechange = function() {
          ...
          } else callback(xhr.readyState + ":" + xhr.status, null);
        };
        xhr.send();
        return xhr;
      },
  ...
  ImageContor: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "9899ep03w9O+b2IqsRmXffd", "ImageContor");
    "use strict";
    cc.Class({
      extends: cc.Component,
      properties: {
  ...
  LoginScene: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "2be2fUArtZAuoP46Cvjj8Je", "LoginScene");
    "use strict";
    var ZJHNetManager = require("ZJHNetManager");
    cc.Class({
      extends: cc.Component,
      ...
      _onButtonTouchEnd: function _onButtonTouchEnd(sender) {
        switch (sender.$) {
         case "1":
  ...
  MemoryDetector: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "13b8cUVZBNNCr8wdfRPt/Sb", "MemoryDetector");
    "use strict";
    var MemoryDetector = {
      _inited: false,
  ...
  NewScript: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "087764WScBKCahQymNrEl2Q", "NewScript");
    "use strict";
    cc.Class({
      extends: cc.Component,
      properties: {
      ...
      start: function start() {},
      onButtonHandlerTouchEnd: function onButtonHandlerTouchEnd(sender) {
        this.progress.progress = sender.progress;
      }
    });
    cc._RF.pop();
  }, {} ],
  ParseObj: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "429d0fyR+lAeqUHkMml1/wW", "ParseObj");
    "use strict";
    cc._RF.pop();
  }, {} ],
  Poker: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "d79a4Q96+JPQJdTwq8nt2ze", "Poker");
    "use strict";
    cc.Class({
      extends: cc.Component,
      properties: {},
      ...
      ShowAnSheCard: function ShowAnSheCard(flag) {
        this.node.color = flag ? new cc.Color(123, 123, 123) : new cc.Color(255, 255, 255);
      }
    });
    cc._RF.pop();
  }, {} ],
  Tip: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "1cbe3N25/dOw6cB5IpUcrQP", "Tip");
    "use strict";
    cc.Class({
      extends: cc.Component,
      properties: {},
      start: function start() {},
      ShowOne: function ShowOne(message, callBack1) {
        bb["ui"].bindComponent(this);
      ...
      ShowTwo: function ShowTwo(message, callBack1, callBack2) {
        bb["ui"].bindComponent(this);
        this["_content"].getComponent(cc.Label).string = message;
        this["_btn1"].active = true;
  ...
  UIKiller: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "acd2bsGUNFJE4Ho4Er5ZwK/", "UIKiller");
    "use strict";
    var DEFAULT_EVENT_NAMES = [ "_onTouchStart", "_onTouchMove", "_onTouchEnd", "_onTouchCancel" ];
    var UIKiller = {
      _prefix: "_",
      _plugins: [],
      registerPlugin: function registerPlugin(plugins) {
        var _this = this;
      ...
      _getComponentName: function _getComponentName(component) {
        return component.name.match(/<.*>$/)[0].slice(1, -1);
      },
      bindComponent: function bindComponent(component, options) {
        var _this2 = this;
        component.$options = options || {};
        var root = component.node;
        root._components.forEach(function(nodeComponent) {
          var name = _this2._getComponentName(nodeComponent);
          name = "$" + name;
      ...
      bindNode: function bindNode(node, target, options) {
        var _this3 = this;
        ...
        node._components.forEach(function(component) {
          var name = _this3._getComponentName(component);
          name = "$" + name;
      ...
      _bindStartByPlugins: function _bindStartByPlugins(node, target) {
        this._plugins.forEach(function(plugin) {
          plugin.onBindStart && plugin.onBindStart(node, target);
        });
      },
      _bindEndByPlugins: function _bindEndByPlugins(node, target) {
        this._plugins.forEach(function(plugin) {
          plugin.onBindEnd && plugin.onBindEnd(node, target);
        });
      },
      _bindNode: function _bindNode(nodeObject, target) {
        var _this4 = this;
        var node = nodeObject;
        node.name[0] === this._prefix && node._components.forEach(function(component) {
          var name = _this4._getComponentName(component);
          name = "$" + name;
          if (_this4[name]) {
          ...
          node[name] = component;
          UIKiller.isFunction(component.onBind) && component.onBind(target);
        });
        var bool = this._checkNodeByPlugins(node, target);
        if (!bool) return;
        node.children.forEach(function(child) {
          var name = child.name;
          if (name[0] === _this4._prefix) {
            ...
            _this4._bindTouchEvent(child, target);
            target[name] = child;
            target.$collector && (target.$collector[name] = child);
          } else node[name] || (node[name] = child);
          _this4._bindNode(child, target);
        });
      },
      _getTouchEventName: function _getTouchEventName(node, event) {
      ...
      _bindTouchEvent: function _bindTouchEvent(node, target, defaultNames) {
        var _this5 = this;
        if (node.getComponent(cc.EditBox)) return;
        var eventNames = defaultNames || this._getTouchEventName(node);
        ...
        eventNames.forEach(function(eventName, index) {
          ...
          node.on(eventTypes[index], function(event) {
            ...
            (eventFunc || button.clickEvents.length) && _this5._beforeHandleEventByPlugins(eventNode, event, !!eventFunc);
            ...
            (eventFunc || button.clickEvents.length) && _this5._afterHandleEventByPlugins(eventNode, event, !!eventFunc, eventResult);
          });
        });
        this._bindTouchLongEvent(node, target);
      },
      _bindTouchLongEvent: function _bindTouchLongEvent(nodeObject, target) {
        var node = nodeObject;
        var eventName = this._getTouchEventName(node, "TouchLong");
        var touchLong = target[eventName];
        if (!UIKiller.isFunction(touchLong)) return;
      ...
      _checkNodeByPlugins: function _checkNodeByPlugins(node, target) {
        var plugin = this._plugins.find(function(item) {
          if (item.onCheckNode) return false === item.onCheckNode(node, target);
          return null;
        });
        return !plugin;
      },
      _beforeHandleEventByPlugins: function _beforeHandleEventByPlugins(node, event, hasEventFunc) {
        this._plugins.forEach(function(item) {
          item.onBeforeHandleEvent && item.onBeforeHandleEvent(node, event, hasEventFunc);
        });
      },
      _afterHandleEventByPlugins: function _afterHandleEventByPlugins(node, event, hasEventFunc, eventResult) {
        this._plugins.forEach(function(item) {
  ...
  UILoader: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "5e603KVY8lL9bEj2uFtSZuY", "UILoader");
    "use strict";
    function initRetain(texture) {
      void 0 != texture.retain && null != texture.retain || (texture.retain = 0);
    }
    function initSceneRetain(texture) {
      if (texture) {
        if (void 0 == texture.retain || null == texture.retain) {
          texture.retain = 1;
          return false;
        }
        return true;
    ...
    function parseStaticRes(item, tag) {
      ...
      } else if (item instanceof cc.Prefab) parseStaticPrefab(item, tag); else if (item instanceof cc.BitmapFont) {
    ...
    function parseStaticPrefab(node, tag) {
      ...
      prefab instanceof cc.Scene || parseStaticNode(prefab, tag);
    ...
    function parseStaticNode(node, tag) {
      var sprite = node.getComponent(cc.Sprite);
      if (sprite && sprite.spriteFrame && _isNullObj(cc.loader._cache[sprite.spriteFrame._textureFilename])) {
      ...
      var button = node.getComponent(cc.Button);
      if (button) {
        if (button.normalSprite && _isNullObj(cc.loader._cache[button.normalSprite._textureFilename])) {
        ...
        if (button.pressedSprite && _isNullObj(cc.loader._cache[button.pressedSprite._textureFilename])) {
        ...
        if (button.hoverSprite && _isNullObj(cc.loader._cache[button.hoverSprite._textureFilename])) {
        ...
        if (button.disabledSprite && _isNullObj(cc.loader._cache[button.disabledSprite._textureFilename])) {
      ...
      var label = node.getComponent(cc.Label);
      if (label && label.font && label.font instanceof cc.BitmapFont && label.font.spriteFrame && _isNullObj(cc.loader._cache[label.font.spriteFrame._textureFilename])) {
      ...
      if (richText && richText.imageAtlas) {
        var keys = Object.keys(richText.imageAtlas._spriteFrames);
        if (keys.length > 0 && _isNullObj(cc.loader._cache[richText.imageAtlas._spriteFrames[keys[0]]._textureFilename])) {
      ...
      var particleSystem = node.getComponent(cc.ParticleSystem);
      if (particleSystem && particleSystem._texture && _isNullObj(cc.loader._cache[particleSystem._texture])) {
        cc.loader._cache[particleSystem._texture].isStatic = true;
        cc.loader._cache[particleSystem._texture].cusTag = tag;
      }
      var pageViewIndicator = node.getComponent(cc.PageViewIndicator);
      if (pageViewIndicator && pageViewIndicator.spriteFrame && _isNullObj(cc.loader._cache[pageViewIndicator.spriteFrame._textureFilename])) {
      ...
      var editBox = node.getComponent(cc.EditBox);
      if (editBox && editBox.backgroundImage && _isNullObj(cc.loader._cache[editBox.backgroundImage._textureFilename])) {
      ...
      var mask = node.getComponent(cc.Mask);
      if (mask && mask.spriteFrame && _isNullObj(cc.loader._cache[mask.spriteFrame._textureFilename])) {
    ...
    function deepCloneObj(obj) {
      ...
      for (i in obj) obj.hasOwnProperty(i) && (o[i] = "Object" === typeof obj[i] ? deepCloneObj(obj[i]) : obj[i]);
      return o;
    }
    function releaseNodeRes() {
      ...
      for (var asset in texturesInCache) {
        if (texturesInCache[asset].isStatic) continue;
      ...
      var release_json = [];
      for (var asset in cc.loader._cache) if (cc.loader._cache[asset].dependKeys && cc.loader._cache[asset].dependKeys.length > 0) {
        var is_release = false;
        for (var i = 0; i < cc.loader._cache[asset].dependKeys.length; i++) -1 !== release_key.indexOf(cc.loader._cache[asset].dependKeys[i]) && (is_release = true);
        if (is_release) {
      ...
      for (var asset in cc.loader._cache) if (cc.loader._cache[asset].dependKeys && cc.loader._cache[asset].dependKeys.length > 0) {
        var is_release = false;
        for (var i = 0; i < cc.loader._cache[asset].dependKeys.length; i++) -1 !== release_json.indexOf(cc.loader._cache[asset].dependKeys[i]) && (is_release = true);
        is_release && cc.loader.release(cc.loader._cache[asset].url);
      }
      release_key = [];
    }
    function _releaseStaticRes(tag) {
      ...
      var release_key = [];
      for (var asset in texturesInCache) {
        if (tag && texturesInCache[asset].cusTag != tag) continue;
    ...
    function _loadPrefabRes(path, callback) {
      cc.loader.loadRes(path, function(err, prefab) {
        err ? cc.error(err.message || err) : callback(prefab);
      });
    }
    function _parseDirRes(list, isReleaseRes) {
      list.forEach(function(item, index) {
        if (item instanceof cc.Texture2D) {
          var key = "";
          if (cc.sys.isNative) key = item.getName(); else {
            var url = item.url;
    ...
    var audioPath = null;
    var UILoader = {
      loadResArr: function loadResArr(pathArr, callback) {
        var index = 0;
        var self = this;
        var prefabArr = [];
        var func = function func() {
          if (index < pathArr.length) _loadPrefabRes(pathArr[index], function(prefab) {
      ...
      replaceButtonTexture: function replaceButtonTexture(target, normalSprite, pressedSprite, hoverSprite, disabledSprite) {
        ...
        normalSprite && _replaceButtonTexture(button, "normalSprite", normalSprite);
        pressedSprite && _replaceButtonTexture(button, "pressedSprite", pressedSprite);
        hoverSprite && _replaceButtonTexture(button, "hoverSprite", hoverSprite);
        disabledSprite && _replaceButtonTexture(button, "disabledSprite", disabledSprite);
        releaseNodeRes();
      },
      instantiate: function instantiate(prefab, target, callback) {
        target && callback || cc.log("参数不对, 请检查参数");
      ...
      beforeSceneLoading: function beforeSceneLoading(event, detail) {
        ...
        if (dependAssets && dependAssets.length > 0) for (var i = 0; i < dependAssets.length; i++) {
          if (cc.loader._cache[dependAssets[i]] && cc.loader._cache[dependAssets[i]].isStatic) {
            key_map[i] = dependAssets[i];
            delete dependAssets[i];
          }
          initSceneRetain(cc.loader._cache[dependAssets[i]]) && (cc.loader._cache[dependAssets[i]].retain -= 1);
        }
        var keys = Object.keys(cc.loader._cache);
        keys.forEach(function(key) {
          cc.loader._cache[key] && !cc.loader._cache[key].isStatic && cc.loader._cache[key].retain > 0 && initSceneRetain(cc.loader._cache[key]) && (cc.loader._cache[key].retain = 0);
        });
      },
      afterSceneLaunch: function afterSceneLaunch(event, detail) {
        for (var key in key_map) event.currentTarget._scene.dependAssets[key] = key_map[key];
        var dependAssets = event.currentTarget._scene.dependAssets;
        if (dependAssets && dependAssets.length > 0) for (var i = dependAssets.length - 1; i >= 0; i--) {
          if (cc.loader._cache[dependAssets[i]] && cc.loader._cache[dependAssets[i]].isStatic) continue;
          initSceneRetain(cc.loader._cache[dependAssets[i]]) && (cc.loader._cache[dependAssets[i]].retain += 1);
        }
        releaseNodeRes();
      },
      ...
      playMusic: function playMusic(path, loop, volume) {
        ...
        audioPath && cc.loader.release(cc.loader._cache[audioPath].url);
        audioPath = path;
  ...
  UserModel: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "4b895j4gO1ByZ3BU/+4P8Zm", "UserModel");
    "use strict";
    var EventManager = require("EventManager");
    bb["user"] = {};
    var EventName = {
    ...
    var UserModel = {
      player: null,
      roomList: null,
      UpdateLogin: function UpdateLogin(msg) {
        if (1 != msg["code"]) {
      ...
      UpdateRoomList: function UpdateRoomList(msgData) {
        this.roomList = msgData.data;
        bb["user"].Event.notifyEvent(EventName.GetRoomListInfo);
      },
      UpdateCreateRoom: function UpdateCreateRoom(msg) {
        if (1 != msg["code"]) {
  ...
  ZJHGameModel: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "c425cq+hBZB/7ThJiqkKTg5", "ZJHGameModel");
    "use strict";
    var EventManager = require("EventManager");
    bb["game"] = {};
    var EventName = {
    ...
    var ZJHGameModel = {
      ...
      roomInfo: null,
      yourIndex: 0,
      updateJoinRoom: function updateJoinRoom(msg) {
        var _this = this;
        if (msg["code"] && 1 != msg["code"]) {
        ...
        msg["data"].roomUserList.forEach(function(item) {
          _this.playerList[_this.getLocalSeat(item.seat_num)] = item;
        });
        this.playerList = msg["data"].roomUserList;
        bb["user"].Event.notifyEvent(EventName.JoinRoomSucess);
      },
      updatePlayerReady: function updatePlayerReady(msg) {
      ...
      getLocalSeat: function getLocalSeat(seat) {
        return (seat - this.yourIndex + 5) % 5;
      },
      getLocalSeatByUid: function getLocalSeatByUid(uid) {
        var index = -1;
        for (var i = 0; i < 5; i++) if (this.playerList[i] && this.playerList[i].id == uid) {
          index = i;
          break;
        }
        return index;
  ...
  ZJHGameScene: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "ed8a0379jJACIsXrc80xEDZ", "ZJHGameScene");
    "use strict";
    var ZJHNetManager = require("ZJHNetManager");
    cc.Class({
      extends: cc.Component,
      ...
      sendCard: function sendCard(playerList) {
        var list = [];
        ...
        for (var _i = 0; _i < 5; _i++) {
          list[_i] = this["_poker" + (_i + 1)].children[0];
          list[_i + playerList.length] = this["_poker" + (_i + 1)].children[1];
          list[_i + 2 * playerList.length] = this["_poker" + (_i + 1)].children[2];
        }
        for (var _i2 = 0; _i2 < list.length; _i2++) list[_i2].position = list[_i2].parent.convertToNodeSpaceAR(cc.v2(0, 0));
      },
      _onBtnReadyTouchEnd: function _onBtnReadyTouchEnd(sender) {
  ...
  ZJHNetManager: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "28ceelS3jNAmKUXC1NHKJc1", "ZJHNetManager");
    "use strict";
    var GameNetManager = require("GameNetManager");
    var ZJHNetManager = cc.Class({
      ...
      statics: {
        ...
        clearEventManager: function clearEventManager() {
          if (this.eventManager) {
      ...
      sendLogin: function sendLogin(phone) {
        var obj = {
          params: {
            tel: phone,
            pwd: "123456"
      ...
      getZJHRoomList: function getZJHRoomList() {
        var sendObj = {
          params: {
            msg: "8"
          },
      ...
      sendJoinRoom: function sendJoinRoom(roomid) {
        var sendObj = {
          params: {
            number: roomid
          },
      ...
      createRoom: function createRoom(moshengren, type, rule, diZhu, ruchang, lichang) {
        var sendObj = {
          params: {
            moshengren: moshengren,
            rule_moshi: type,
            rule_men: rule,
            dizhu: diZhu,
            ruchang: ruchang,
  ...
  ZJHPlayer: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "c591adkxehEbLDQZaenZc4A", "ZJHPlayer");
    "use strict";
    cc.Class({
      extends: cc.Component,
      properties: {
      ...
      start: function start() {
        ...
        if (this.index >= playerList.length) this.node.active = false; else {
          this.node.active = true;
          this.nick.string = playerList[this.index].nick;
          this.gold.string = playerList[this.index].admin;
        }
        if (!playerList[this.index]) return;
        if (playerList[this.index].status < 2) {
          this.state.node.active = false;
          0 == this.index ? this.node.getChildByName("_btnReady").active = true : this.state.spriteFrame = this.state.getComponent("ImageContor").sprites[0];
        }
      },
      onDestroy: function onDestroy() {
        bb["game"].Event.removeObserver(this);
      ...
      updatePlayerReady: function updatePlayerReady() {
        var playerList = bb.game.Module.playerList;
        if (2 == playerList[this.index].status) {
          this.state.node.active = true;
          this.state.spriteFrame = this.state.getComponent("ImageContor").sprites[1];
          0 == this.index && (this.node.getChildByName("_btnReady").active = true);
        }
      },
      onEventMessage: function onEventMessage(msgId, obj) {
        switch (msgId) {
         case bb["game"].Name.ReadyResult:
          this.index == parseInt(obj) && this.updatePlayerReady();
          break;
...
}, {}, [ "App", "EventManager", "AppLog", "ParseObj", "GameNetManager", "Http", "MemoryDetector", "UILoader", "UIKiller", "Poker", "CreateRoom", "DropDownMenu", "EnterRoom", "GameConter", "GameMsg", "NewScript", "HallRoomList", "HallScene", "LoginScene", "Tip", "UserModel", "ImageContor", "BatMenu", "ZJHGameScene", "ZJHNetManager", "ZJHPlayer", "ZJHGameModel" ]);